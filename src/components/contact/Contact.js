    ...
    >
      <motion.div variants={variants} className="textContainer">
        ...
        <motion.div className="item" variants={variants}>
          ...
          <a id="email_id" href="mailto:nr859696@gmail.com">
            nr859696@gmail.com
          </a>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h3>
            <label for="adress_location">Address</label>
          </h3>
          <a
            target="_blank"
            rel="noopener noreferrer"
            id="adress_location"
            href="https://www.google.com/maps/search/?api=1&query=Darga+Road,Gulbarga.585104"
          >
            Darga Road, Gulbarga.585104
          </a>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h3>
